                    ...
                    if(args.length == 0){
                        ...
                        try{
                            ...
                            try{
                                ...
                                player.sendMessage(ColorsAPI.colors(configUtil.getMessages().getString("Messages.hub-not-found").replace("{hub}", args[0])));
                            }
                        }catch (NumberFormatException x){
                            player.sendMessage(ColorsAPI.colors(configUtil.getMessages().getString("Messages.only-numbers")));
                        }
                    }
                }else{
