...
public class ConfigUtil {
    ...
    private File blockedcmds = new File(plugin.getDataFolder(), "blockedcmds.yml");
    ...
    public void saveBlockedcmds() throws IOException{
        ConfigurationProvider.getProvider(YamlConfiguration.class).save(blockedcmdsConfiguration, new File(plugin.getDataFolder(), "blockedcmds.yml"));
    }

    public Configuration getBlockedcmds() throws IOException{
        blockedcmdsConfiguration = ConfigurationProvider.getProvider(YamlConfiguration.class).load(blockedcmds);
        return blockedcmdsConfiguration;
    }
